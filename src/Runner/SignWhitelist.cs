// <auto-generated/>
// 由 lagrange/tools/gen_whitelist.py 从 lagrange-core BotSignProvider.cs 提取生成。
// 对应 Lagrange.Core DefaultBotSignProvider（Linux 协议）的签名白名单。
namespace RunnerWin;

internal static class SignWhitelist
{
    // 532 commands
